...
//   final res = BehaviorSubject<PlaybackState>(sync: true);
//   final sub = super.playbackState.listen(
//         (e) => res.add(e.copyWith(controls: [
//           MediaControl(
//             androidIcon: "drawable/baseline_delete_24",
//             label: "delete",
//             action: MediaAction.setCaptioningEnabled,
//           ),
//           ...e.controls,
//           // MediaControl(
//           //   androidIcon: "drawable/baseline_delete_24",
...
//           // ),
//         ])),
//         onError: res.addError,
//         onDone: res.close,
//       );
//   res.onCancel = () => sub.cancel();
//
//   return res;
// }
//
...
//       await _markAs(index, KeepState.kept);
//       return null;
//     case 'markAsDeleted':
//       final index = extras!['index'] as int;
//       await _markAs(index, KeepState.deleted);
//       return null;
//     case 'markAsUnspecified':
//       final index = extras!['index'] as int;
//       await _markAs(index, KeepState.unspecified);
//       return null;
//     default:
...
// }
//
// Future<void> _markAs(int musicIdx, KeepState state) {
//   final music = _queue.queue[musicIdx];
//   return store.markAs(music, state);
// }
